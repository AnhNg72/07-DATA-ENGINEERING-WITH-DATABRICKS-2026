...
-- MAGIC       - `/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-spark-declarative-pipelines-en_us-3.x.x/Build Data Pipelines with Lakeflow Spark Declarative Pipelines/2 - Developing a Simple Pipeline Project`
-- MAGIC
-- MAGIC     - **Source code paths**: Within the same root folder as above, select the **orders** folder: 
-- MAGIC       - `/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-spark-declarative-pipelines-en_us-3.x.x/Build Data Pipelines with Lakeflow Spark Declarative Pipelines/2 - Developing a Simple Pipeline Project/orders`
-- MAGIC
